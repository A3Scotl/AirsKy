...
public class FlightServiceImpl implements FlightService {
    ...
    private List<FlightTravelClass> generateStandardTravelClasses(Flight flight) {
        ...
        if (economyClass.getPriceMultiplier() == null) {
            throw new IllegalStateException("Economy travel class price multiplier is null. Please run setup_standard_travel_classes.sql");
        }
        if (businessClass.getPriceMultiplier() == null) {
            throw new IllegalStateException("Business travel class price multiplier is null. Please run setup_standard_travel_classes.sql");
        }
        if (firstClass.getPriceMultiplier() == null) {
            throw new IllegalStateException("First travel class price multiplier is null. Please run setup_standard_travel_classes.sql");
        }
        ...
        BigDecimal basePrice = flight.getBasePrice();
        if (basePrice == null) {
            throw new IllegalStateException("Flight basePrice is null when generating travel classes. Flight ID: " + flight.getFlightId());
        }
