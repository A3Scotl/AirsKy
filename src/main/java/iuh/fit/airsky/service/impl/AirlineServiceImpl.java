...
public class AirlineServiceImpl implements AirlineService {
    ...
    public AirlineServiceImpl(AirlineRepository airlineRepository, AirlineMapper airlineMapper, GenerateCodeUtil generateCodeUtil) {
    ...
    public AirlineResponse createAirline(AirlineRequest request) {
        ...
        airline.setAirlineCode(generateCodeUtil.generateAirlineCode(airlineRepository));
